...
bool ADC_ChannelEnable(ADC_CHANNEL channel)
{
    switch(channel)
    {
        ...
        case ADC_CHANNEL_16:
            ...
            return true;
        case ADC_CHANNEL_12:
            ANSELCbits.ANSELC0 = 1;     // AN12/C0 selected as analog
            return true;
        case ADC_CHANNEL_20:
            ANSELEbits.ANSELE0 = 1;     // AN20/RE0  selected as analog
        case ADC_CHANNEL_22:
            ANSELEbits.ANSELE2 = 1;     // AN22/RE2 selected as analog
        case ADC_CHANNEL_23:
            ANSELEbits.ANSELE3 = 1;     // AN23/RE3 selected as analog
        default:
            return false;
    }
...
bool ADC_SetConfiguration(ADC_CONFIGURATION configuration)
{
    ...
    {
        ADCON1L = 0x0000;       //ADC operates in idle mode.
        ADCON1H = 0x0060;       //Integer output formatting, 12-bit resolution
                                // 0000 0000 0110 0000
        
        // Frequency (FCY) = 180000000
        if(FCY > 30000000)
        {
        ...
        ADCON3H = 0x0080;       //TCORESRC = FSYS = peripheral frequency = Fosc /2, Enable the "shared" ADC core
