...
#define ADC_CHANNEL_POTENTIOMETER ADC_CHANNEL_4
#define ADC_CHANNEL_TEMPERATURE_SENSOR ADC_CHANNEL_16
#define ADCInput ADC_CHANNEL_12
#define RedADCInput ADC_CHANNEL_20      // AN20/RE0
#define GreenADCInput ADC_CHANNEL_22    // AN22/RE2
#define BlueADCInput ADC_CHANNEL_23     // AN23/RE3

typedef enum
{
    ADC_CHANNEL_20 = 20, //RedADCInput AN20/RE0
    ADC_CHANNEL_22 = 22, //GreenADCInput AN22/RE2
    ADC_CHANNEL_23 = 23, //BlueADCInput AN23/RE3
    ADC_CHANNEL_16 = 16,
    ADC_CHANNEL_4 = 4,
    ADC_CHANNEL_12 = 12
